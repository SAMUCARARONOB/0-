...
local function carregarTemaSalvo()
    ...
    local jsonPath = "RANOXHubConfigs/RANOXHub.json"
...
local function ConstruirInterface(tema)
    ...
    ConfigTab:CreateButton({
        ...
        Callback = function()
            ...
            pcall(function()
                writefile("RANOXHubConfigs/theme.txt", novoTema)
            end)
    ...
    ConfigTab:CreateToggle({
        ...
        Callback = function(Value)
            if Value then
                ...
                task.spawn(function()
                    while LocalPlayer.PlayerGui:FindFirstChild("RANOX_PING") do
    ...
    CreditsTab:CreateLabel("Desenvolvido por Keybrew")
    CreditsTab:CreateLabel("YouTube: @rnox_ofc123")
